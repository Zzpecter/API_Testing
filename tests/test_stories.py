...
def fixture_project(new_project_data):
    ...
    my_request_controller.send_request('DELETE', f"/projects/{fixture_project_id}")
...
def fixture_story(fixture_project, new_story_data):
    _, fixture_project_id = fixture_project
    response = my_request_controller.send_request('POST', f"/projects/{fixture_project_id}/stories/",
                                                  payload=new_story_data).json()
    fixture_story_id = response['id']
    yield response, fixture_project_id, fixture_story_id
    my_request_controller.send_request('DELETE', f"/projects/{fixture_project_id}/stories/{fixture_story_id}")


def test_get_all_stories(fixture_project):
    _, fixture_project_id = fixture_project
    response = my_request_controller.send_request('GET', f"/projects/{fixture_project_id}/stories/")
...
def test_get_one_story(fixture_story):
    ...
    response = my_request_controller.send_request('GET', f"/projects/{fixture_project_id}/stories/{fixture_story_id}")
...
def test_put_update_story(fixture_story, update_story_data):
    ...
    response = my_request_controller.send_request('PUT', f"/projects/{fixture_project_id}/stories/{fixture_story_id}",
...
def test_delete_story(fixture_story):
    ...
    response = my_request_controller.send_request('DELETE',
                                                  f"/projects/{fixture_project_id}/stories/{fixture_story_id}")
