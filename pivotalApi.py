...
class PivotalApi:
    ...
    def run(self, request_method, endpoint, payload=None, print_response=False):
        response = self.my_request_controller.send_request(request_method, endpoint, payload)
        if print_response:
            self.my_request_controller.print_response()
        return response
...
if __name__ == '__main__':
    ...
    # .... :::: Get my profile :::: ....
    api.run('GET', '/me' , print_response=True)
    time.sleep(2)

    # .... :::: Get all projects :::: ....
    api.run('GET', '/projects', print_response=True)
    time.sleep(2)

    # .... :::: Get specific project :::: ....
    api.run('GET', f'/projects/{first_project_id}', print_response=True)
    time.sleep(2)
    ...
    response = api.run('POST', '/projects/', payload=payload_dict, print_response=True)
    ...
    response = api.run('POST', f'/projects/{new_project_id}/stories/', payload=payload_dict, print_response=True)
    response_dict = response.json()
    new_story_id = response_dict['id']
    time.sleep(2)

    # .... :::: Get all stories from project :::: ....
    api.run('GET', f'/projects/{new_project_id}/stories/', print_response=True)
    time.sleep(2)

    # .... :::: Get a specific story from project :::: ....
    api.run('GET', f'/projects/{new_project_id}/stories/{new_story_id}', print_response=True)
    time.sleep(2)
    ...
    api.run('PUT', f'/projects/{new_project_id}/stories/{new_story_id}', payload=payload_dict, print_response=True)
    time.sleep(2)

    # .... :::: Delete a specific story from project :::: ....
    api.run('DELETE', f'/projects/{new_project_id}/stories/{new_story_id}', print_response=True)
    time.sleep(2)
    ...
    api.run('PUT', f'/projects/{new_project_id}', payload=payload_dict, print_response=True)
    time.sleep(2)

    # .... :::: Delete a specific project :::: ....
    api.run('DELETE', f'/projects/{new_project_id}', print_response=True)